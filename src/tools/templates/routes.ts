...
const create__singleResource__(pascalCase) = async (request: Request, response: Response, next: NextFunction) => {
  try {
    const {} = request.body;
...
const update__singleResource__(pascalCase) = async (request: Request, response: Response, next: NextFunction) => {
  try {
...
const get__resource__(pascalCase) = async (request: Request, response: Response, next: NextFunction) => {
  try {
...
const get__singleResource__(pascalCase) = async (request: Request, response: Response, next: NextFunction) => {
  try {
    const { __identifier__ } = request.params;
...
const delete__singleResource__(pascalCase) = async (request: Request, response: Response, next: NextFunction) => {
  try {
    const { __identifier__ } = request.params;
